...
init python:
    ...
    def kroti(arg1,zi,ii):
        global clz1,clz2,clz3,clz4,clz5,clz6,clz7
        for z in range(1,7):
            for i in range(0,9):
                globals()["clz"+str(z)][i]=0
        globals()["clz"+str(zi)][ii]=arg1
        return
    def krib():
            ...
            if cl1[i]>0:
                ...
                if i<7:
                    if cl1[i]==cl1[i+1]==cl1[i+2]:
                        ...
                        if i<6 and cl1[i]==cl1[i+3]:
                            ...
                            ktmr+=2
                            cl1[i+3]=0
                        clz1[i],clz1[i+1],clz1[i+2]=180,180,180
                        renpy.pause(0.05)
                ...
                if cl1[i]==cl2[i]==cl3[i]:
                    ...
                    if cl1[i]==cl4[i]:
                        ...
                        ktmr+=2
                        cl4[i]=0
                    clz1[i],clz2[i],clz3[i]=180,180,180
                    renpy.pause(0.05)
            ...
            if cl2[i]>0:
                ...
                if i<7:
                    if cl2[i]==cl2[i+1]==cl2[i+2]:
                        ...
                        if i<6 and cl2[i]==cl2[i+3]:
                            ...
                            ktmr+=2
                            cl2[i+3]=0
                        clz2[i],clz2[i+1],clz2[i+2]=180,180,180
                        renpy.pause(0.05)
                ...
                if cl2[i]==cl3[i]==cl4[i]:
                    ...
                    if cl2[i]==cl5[i]:
                        ...
                        ktmr+=2
                        cl5[i]=0
                    clz2[i],clz3[i],clz4[i]=180,180,180
                    renpy.pause(0.05)
            ...
            if cl3[i]>0:
                ...
                if i<7:
                    if cl3[i]==cl3[i+1]==cl3[i+2]:
                        ...
                        if i<6 and cl3[i]==cl3[i+3]:
                            ...
                            ktmr+=2
                            cl3[i+3]=0
                        clz3[i],clz3[i+1],clz3[i+2]=180,180,180
                        renpy.pause(0.05)
                ...
                if cl3[i]==cl4[i]==cl5[i]:
                    ...
                    if cl3[i]==cl6[i]:
                        ...
                        ktmr+=2
                        cl6[i]=0
                    clz3[i],clz4[i],clz5[i]=180,180,180
                    renpy.pause(0.05)
            ...
            if cl5[i]>0:
                if cl5[i]==cl5[i+1]==cl5[i+2]:
                    ...
                    if i<6 and cl5[i]==cl5[i+3]:
                        ...
                        ktmr+=2
                        cl5[i+3]=0
                    clz5[i],clz5[i+1],clz5[i+2]=180,180,180
                    renpy.pause(0.05)
            ...
            if cl6[i]>0:
                if cl6[i]==cl6[i+1]==cl6[i+2]:
                    ...
                    if i<6 and cl6[i]==cl6[i+3]:
                        ...
                        ktmr+=2
                        cl6[i+3]=0
                    clz6[i],clz6[i+1],clz6[i+2]=180,180,180
                    renpy.pause(0.05)
...
screen krixx:
    ...
    for z in range(1,7):
        for i in range(0,9):
            image im.MatrixColor("k"+str(globals()["cl"+str(z)][i])+".w",im.matrix.hue(globals()["clz"+str(z)][i]))xpos(i*80+260)ypos(z*80+20+globals()["clp"+str(z)][i])
label krich:
    show screen krixx
    if krix>=0:
...
label krix:
    ...
    python:
        ...
        clp0,clp1,clp2,clp3,clp4,clp5,clp6,clp7,clz0,clz1,clz2,clz3,clz4,clz5,clz6,clz7=[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]
        for z in range(1,7):
            for i in range(0,9):
                globals()["clp"+str(z)].append(0)
        for z in range(1,7):
            for i in range(0,9):
                globals()["clz"+str(z)].append(0)
    call screen krix
    return